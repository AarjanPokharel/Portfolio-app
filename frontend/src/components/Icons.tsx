...
export function PythonIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M14.25.18l.9.2.73.26.59.3.45.32.34.34.25.34.16.33.1.3.04.26.02.2-.01.13V8.5l-.05.63-.13.55-.21.46-.26.38-.3.31-.33.25-.35.19-.35.14-.33.1-.3.07-.26.04-.21.02H8.77l-.69.05-.59.14-.5.22-.41.27-.33.32-.27.35-.2.36-.15.37-.1.35-.07.32-.04.27-.02.21v3.06H3.17l-.21-.03-.28-.07-.32-.12-.35-.18-.36-.26-.36-.36-.35-.46-.32-.59-.28-.73-.21-.88-.14-1.05L0 11.97l.06-1.22.16-1.04.24-.87.32-.71.36-.57.4-.44.42-.33.42-.24.4-.16.36-.1.32-.05.26-.02.21-.01h5.74l.68-.05.57-.13.48-.2.4-.26.31-.3.25-.33.2-.34.14-.34.1-.32.07-.28.04-.22.02-.17V1.46l.05-.44.12-.4.18-.35.22-.3.26-.26.28-.21.28-.16.26-.11.24-.07.2-.04.17-.02.13-.01zm-4.6 6.26a.82.82 0 1 0 0 1.63.82.82 0 0 0 0-1.63z"/>
      <path d="M15.75 23.82l-.9-.2-.73-.26-.59-.3-.45-.32-.34-.34-.25-.34-.16-.33-.1-.3-.04-.26-.02-.2.01-.13v-6.18l.05-.63.13-.55.21-.46.26-.38.3-.31.33-.25.35-.19.35-.14.33-.1.3-.07.26-.04.21-.02h6.28l.69-.05.59-.14.5-.22.41-.27.33-.32.27-.35.2-.36.15-.37.1-.35.07-.32.04-.27.02-.21v-3.06h2.79l.21.03.28.07.32.12.35.18.36.26.36.36.35.46.32.59.28.73.21.88.14 1.05.05 1.23-.06 1.22-.16 1.04-.24.87-.32.71-.36.57-.4.44-.42.33-.42.24-.4.16-.36.1-.32.05-.26.02-.21.01h-5.74l-.68.05-.57.13-.48.2-.4.26-.31.3-.25.33-.2.34-.14.34-.1.32-.07.28-.04.22-.02.17v4.72l-.05.44-.12.4-.18.35-.22.3-.26.26-.28.21-.28.16-.26.11-.24.07-.2.04-.17.02-.13.01zm4.6-6.26a.82.82 0 1 0 0-1.63.82.82 0 0 0 0 1.63z"/>
    </svg>
  );
}
...
export function RoleIcon({ icon, className }: { icon: string; className?: string }) {
  switch (icon) {
    ...
    case 'linux':      return <LinuxIcon className={className} />;
    case 'cloud':      return <CloudIcon className={className} />;
    case 'devops':     return <GearIcon className={className} />;
    case 'backend':    return <ServerIcon className={className} />;
    case 'automation': return <AutomationIcon className={className} />;
    case 'security':   return <ShieldIcon className={className} />;
